...
![FCJ_ws2](/images/6.codedeploy/101.png)
...
![FCJ_ws2](/images/6.codedeploy/102.png)
...
![FCJ_ws2](/images/6.codedeploy/103.png)

4. Nhập tên `ecsTaskExecutionRole`.

![FCJ_ws2](/images/6.codedeploy/104.png)

5. Kiểm tra policy và nhấn **Create role**.

![FCJ_ws2](/images/6.codedeploy/105.png)

6. Xác nhận tạo role thành công.

![FCJ_ws2](/images/6.codedeploy/106.png)

### Tạo CodeDeploy Role cho ECS

7. Tiếp tục chọn **Create role**.

![FCJ_ws2](/images/6.codedeploy/201.png)
